...
const Page1 = () => {
  ...
  // function displayRightBar (cStatus) {
  //   if(cStatus === "userManagement"){
  //     return <UserManagement />
  //   }
  //   else if(cStatus === "CLOSED"){
  //     return <TiTick className="icon" />
  //   }
  //   else if(cStatus === "BOOKMARKED"){
  //     return <MdBookmarkAdded className="icon" />
  //   }
  // }
    ...
    <div className="amain">
      <div className="aleft">
        ...
        <div className="details">
          ...
          {typeUser === "Admin" && <p onClick={() => setCListStatus("userManagement")}>Users and Feedback</p>}
          {typeUser === "HOD" && <p onClick={() => navigate("/hodDashboard")}>HOD Dashboard</p>}
      ...
      {cListStatus === "userManagement" && <UserManagement />}
      {cListStatus === "trackStatus" && <TrackStatus />}
      {cListStatus === "OFF" && (
        <div className="aright">
          <div className="con1">
            <div className="mobiles"></div>
            <div className="cd">USER DASHBOARD</div>
          </div>
          <div className="con2">
            <div
              className="acard"
      ...
      {cListStatus === "ON" && (
        <ComplaintListUser userType={typeUser} status={status} listOff={handleListOff}/>
      )}
      {cListStatus === "HELP" && (
