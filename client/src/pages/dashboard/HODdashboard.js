...
const HODDashboard = () => {
  ...
  return (
    <div className="amain">
      ...
      {cListStatus === "OFF" && (
        <div className="aright">
          <div className="con1">
            ...
            <div className="cd">HOD DASHBOARD</div>
          </div>
          <div className="con2">
            <div
              className="acard"
              style={{backgroundColor: "red"}}
              onClick={() => handleOpenList("New")}
            >
              <div className="cr">
            ...
            <div className="acard" style={{backgroundColor: "blue"}} onClick={() => handleOpenList("Valid")}>
              <div className="cr">
                <p className="cp"> VALID COMPLAINTS </p>
                <p className="cp">2</p>
                <p className="cv">
                  view
                  <svg
      ...
      {cListStatus === "ON" && (
        <ComplaintList userType={typeUser} status={status} listOff={handleListOff}/>
      )}
      {cListStatus === "HELP" && (
