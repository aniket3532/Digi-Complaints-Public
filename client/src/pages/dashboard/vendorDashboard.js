...
import ComplaintListVendor from "../../components/complaintList/complaintListVendor";
...
const VendorDashboard = () => {
  ...
  return (
    <div className="amain">
      ...
      {cListStatus === "OFF" && (
        <div className="aright">
          <div className="con1">
            ...
            <div className="cd"> VENDOR DASHBOARD</div>
          </div>
          <div className="con2">
            <div
              className="acard"
              style={{backgroundColor: "red"}}
              onClick={() => handleOpenList("Job Posted")}
            >
              <div className="cr">
                <p className="cp"> JOBS POSTED </p>
                <p className="cp">2</p>
                <p className="cv">
                  view
                  <svg
            ...
            <div className="acard" style={{backgroundColor: "blue"}} onClick={() => handleOpenList("Vendor Assigned")}>
              <div className="cr">
                <p className="cp"> ASSIGNED JOBS </p>
                <p className="cp">2</p>
                <p className="cv">
                  view
                  <svg
      ...
      {cListStatus === "ON" && (
        <ComplaintListVendor userType={typeUser} status={status} listOff={handleListOff}/>
      )}
      {cListStatus === "HELP" && (
